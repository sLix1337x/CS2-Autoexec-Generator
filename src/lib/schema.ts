...
export const autoexecFormSchema = z.object({
  ...
  includeSections: z.object({
    binds: z.boolean().default(true),
    customBinds: z.boolean().default(true),
    aliases: z.boolean().default(true),
    settings: z.boolean().default(true),
    hud: z.boolean().default(true),
    hudAdvanced: z.boolean().default(true),
    mouseCrosshair: z.boolean().default(true),
    viewmodel: z.boolean().default(true),
    video: z.boolean().default(true),
    sound: z.boolean().default(true),
    rate: z.boolean().default(true),
    additional: z.boolean().default(true),
